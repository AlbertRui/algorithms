...
public class Selection {
    ...
    // 求出nums[l...r]范围里第k小的数
    private static <T extends Comparable<T>> T solve(T[] nums, int l, int r, int k) {
     ...
     * @return
     */
    private static <T extends Comparable<T>> T solve(T[] nums, int k) {
    ...
    private static <T extends Comparable<T>> T solve2(T[] nums, int k) {
